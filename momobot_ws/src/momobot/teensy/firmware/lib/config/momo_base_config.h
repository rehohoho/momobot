#ifndef MOMO_BASE_CONFIG_H
#define MOMO_BASE_CONFIG_H

//uncomment the base you're building
#define MOMO_BASE DIFFERENTIAL_DRIVE // 2WD and Tracked robot w/ 2 motors
...
#define LR_WHEELS_DISTANCE 0.356  // distance between left and right wheels
